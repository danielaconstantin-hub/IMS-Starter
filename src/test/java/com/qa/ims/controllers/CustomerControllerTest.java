...
public class CustomerControllerTest {
	...
	public void testCreate() {
		final String F_NAME = "barry", L_NAME = "scott", U_NAME = "barryscott", P_WORD = "barry1234";
	...
	public void testReadAll() {
		...
		customers.add(new Customer(1L, "jordan", "harrison","jordanhar", "jordan1234" ));
	...
	public void testUpdate() {
		Customer updated = new Customer(1L, "chris", "perrins", "chrisperrins", "chris1234");
